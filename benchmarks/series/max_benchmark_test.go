...
// Max benchmarks for Small size
// Int8
func BenchmarkMax_Small_Int8(b *testing.B) {
...
func BenchmarkGotaMax_Small_Int8(b *testing.B) {
	// Generate a small dataset (10,000 elements)
...
// Int16
func BenchmarkMax_Small_Int16(b *testing.B) {
	// Generate a small dataset (10,000 elements)
...
func BenchmarkGotaMax_Small_Int16(b *testing.B) {
	// Generate a small dataset (10,000 elements)
...
// Int32
func BenchmarkMax_Small_Int32(b *testing.B) {
	// Generate a small dataset (10,000 elements)
...
func BenchmarkGotaMax_Small_Int32(b *testing.B) {
	// Generate a small dataset (10,000 elements)
...
// Int64
func BenchmarkMax_Small_Int64(b *testing.B) {
	// Generate a small dataset (10,000 elements)
...
func BenchmarkGotaMax_Small_Int64(b *testing.B) {
	// Generate a small dataset (10,000 elements)
...
// Uint8
func BenchmarkMax_Small_Uint8(b *testing.B) {
	// Generate a small dataset (10,000 elements)
...
func BenchmarkGotaMax_Small_Uint8(b *testing.B) {
	// Generate a small dataset (10,000 elements)
...
// Uint16
func BenchmarkMax_Small_Uint16(b *testing.B) {
	// Generate a small dataset (10,000 elements)
...
func BenchmarkGotaMax_Small_Uint16(b *testing.B) {
	// Generate a small dataset (10,000 elements)
...
// Uint32
func BenchmarkMax_Small_Uint32(b *testing.B) {
	// Generate a small dataset (10,000 elements)
...
func BenchmarkGotaMax_Small_Uint32(b *testing.B) {
	// Generate a small dataset (10,000 elements)
...
// Uint64
func BenchmarkMax_Small_Uint64(b *testing.B) {
	// Generate a small dataset (10,000 elements)
...
func BenchmarkGotaMax_Small_Uint64(b *testing.B) {
	// Generate a small dataset (10,000 elements)
...
// Float32
func BenchmarkMax_Small_Float32(b *testing.B) {
	// Generate a small dataset (10,000 elements)
...
func BenchmarkGotaMax_Small_Float32(b *testing.B) {
	// Generate a small dataset (10,000 elements)
...
// Float64
func BenchmarkMax_Small_Float64(b *testing.B) {
	// Generate a small dataset (10,000 elements)
...
func BenchmarkGotaMax_Small_Float64(b *testing.B) {
	// Generate a small dataset (10,000 elements)
...
// Max benchmarks for Medium size
// Int8
func BenchmarkMax_Medium_Int8(b *testing.B) {
...
func BenchmarkGotaMax_Medium_Int8(b *testing.B) {
	// Generate a medium dataset (1,000,000 elements)
...
// Int16
func BenchmarkMax_Medium_Int16(b *testing.B) {
	// Generate a medium dataset (1,000,000 elements)
...
func BenchmarkGotaMax_Medium_Int16(b *testing.B) {
	// Generate a medium dataset (1,000,000 elements)
...
// Int32
func BenchmarkMax_Medium_Int32(b *testing.B) {
	// Generate a medium dataset (1,000,000 elements)
...
func BenchmarkGotaMax_Medium_Int32(b *testing.B) {
	// Generate a medium dataset (1,000,000 elements)
...
// Int64
func BenchmarkMax_Medium_Int64(b *testing.B) {
	// Generate a medium dataset (1,000,000 elements)
...
func BenchmarkGotaMax_Medium_Int64(b *testing.B) {
	// Generate a medium dataset (1,000,000 elements)
...
// Uint8
func BenchmarkMax_Medium_Uint8(b *testing.B) {
	// Generate a medium dataset (1,000,000 elements)
...
func BenchmarkGotaMax_Medium_Uint8(b *testing.B) {
	// Generate a medium dataset (1,000,000 elements)
...
// Uint16
func BenchmarkMax_Medium_Uint16(b *testing.B) {
	// Generate a medium dataset (1,000,000 elements)
...
func BenchmarkGotaMax_Medium_Uint16(b *testing.B) {
	// Generate a medium dataset (1,000,000 elements)
...
// Uint32
func BenchmarkMax_Medium_Uint32(b *testing.B) {
	// Generate a medium dataset (1,000,000 elements)
...
func BenchmarkGotaMax_Medium_Uint32(b *testing.B) {
	// Generate a medium dataset (1,000,000 elements)
...
// Uint64
func BenchmarkMax_Medium_Uint64(b *testing.B) {
	// Generate a medium dataset (1,000,000 elements)
...
func BenchmarkGotaMax_Medium_Uint64(b *testing.B) {
	// Generate a medium dataset (1,000,000 elements)
...
// Float32
func BenchmarkMax_Medium_Float32(b *testing.B) {
	// Generate a medium dataset (1,000,000 elements)
...
func BenchmarkGotaMax_Medium_Float32(b *testing.B) {
	// Generate a medium dataset (1,000,000 elements)
...
// Float64
func BenchmarkMax_Medium_Float64(b *testing.B) {
	// Generate a medium dataset (1,000,000 elements)
...
func BenchmarkGotaMax_Medium_Float64(b *testing.B) {
	// Generate a medium dataset (1,000,000 elements)
...
// Max benchmarks for Large size
// Int8
func BenchmarkMax_Large_Int8(b *testing.B) {
...
func BenchmarkGotaMax_Large_Int8(b *testing.B) {
	// Skip this benchmark in short mode
	if testing.Short() {
		b.Skip("skipping large benchmark in short mode")
	}
...
// Int16
func BenchmarkMax_Large_Int16(b *testing.B) {
	// Skip this benchmark in short mode
	if testing.Short() {
		b.Skip("skipping large benchmark in short mode")
	}
...
func BenchmarkGotaMax_Large_Int16(b *testing.B) {
	// Skip this benchmark in short mode
	if testing.Short() {
		b.Skip("skipping large benchmark in short mode")
	}
...
// Int32
func BenchmarkMax_Large_Int32(b *testing.B) {
	// Skip this benchmark in short mode
	if testing.Short() {
		b.Skip("skipping large benchmark in short mode")
	}
...
func BenchmarkGotaMax_Large_Int32(b *testing.B) {
	// Skip this benchmark in short mode
	if testing.Short() {
		b.Skip("skipping large benchmark in short mode")
	}
...
// Int64
func BenchmarkMax_Large_Int64(b *testing.B) {
	// Skip this benchmark in short mode
	if testing.Short() {
		b.Skip("skipping large benchmark in short mode")
	}
...
func BenchmarkGotaMax_Large_Int64(b *testing.B) {
	// Skip this benchmark in short mode
	if testing.Short() {
		b.Skip("skipping large benchmark in short mode")
	}
...
// Uint8
func BenchmarkMax_Large_Uint8(b *testing.B) {
	// Skip this benchmark in short mode
	if testing.Short() {
		b.Skip("skipping large benchmark in short mode")
	}
...
func BenchmarkGotaMax_Large_Uint8(b *testing.B) {
	// Skip this benchmark in short mode
	if testing.Short() {
		b.Skip("skipping large benchmark in short mode")
	}
...
// Uint16
func BenchmarkMax_Large_Uint16(b *testing.B) {
	// Skip this benchmark in short mode
	if testing.Short() {
		b.Skip("skipping large benchmark in short mode")
	}
...
func BenchmarkGotaMax_Large_Uint16(b *testing.B) {
	// Skip this benchmark in short mode
	if testing.Short() {
		b.Skip("skipping large benchmark in short mode")
	}
...
// Uint32
func BenchmarkMax_Large_Uint32(b *testing.B) {
	// Skip this benchmark in short mode
	if testing.Short() {
		b.Skip("skipping large benchmark in short mode")
	}
...
func BenchmarkGotaMax_Large_Uint32(b *testing.B) {
	// Skip this benchmark in short mode
	if testing.Short() {
		b.Skip("skipping large benchmark in short mode")
	}
...
// Uint64
func BenchmarkMax_Large_Uint64(b *testing.B) {
	// Skip this benchmark in short mode
	if testing.Short() {
		b.Skip("skipping large benchmark in short mode")
	}
...
func BenchmarkGotaMax_Large_Uint64(b *testing.B) {
	// Skip this benchmark in short mode
	if testing.Short() {
		b.Skip("skipping large benchmark in short mode")
	}
...
// Float32
func BenchmarkMax_Large_Float32(b *testing.B) {
	// Skip this benchmark in short mode
	if testing.Short() {
		b.Skip("skipping large benchmark in short mode")
	}
...
func BenchmarkGotaMax_Large_Float32(b *testing.B) {
	// Skip this benchmark in short mode
	if testing.Short() {
		b.Skip("skipping large benchmark in short mode")
	}
...
// Float64
func BenchmarkMax_Large_Float64(b *testing.B) {
	// Skip this benchmark in short mode
	if testing.Short() {
		b.Skip("skipping large benchmark in short mode")
	}
...
func BenchmarkGotaMax_Large_Float64(b *testing.B) {
	// Skip this benchmark in short mode
	if testing.Short() {
		b.Skip("skipping large benchmark in short mode")
	}
